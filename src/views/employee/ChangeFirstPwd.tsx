...
import { useChangeFirstPwdMutation } from '@/types/generated/types';
...
const ChangeFirstPwd = (props: IChangePwd) => {
  ...
  const [changeFirstPwdMutation, { loading }] = useChangeFirstPwdMutation();

  const onChangePwd = (inputData: IEmployeePwdChangeFormValues) => {
    console.log(inputData);

    changeFirstPwdMutation({
      variables: {
        email: props?.emailInfo,
