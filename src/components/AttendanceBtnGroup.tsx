...
const AttendanceBtnGroup = () => {
  ...
  const workBtnDisabledClass = 'py-2.5 px-5 mr-2 mb-2 text-sm font-medium text-gray-900 rounded-lg border border-gray-200 bg-blue-400';
          ...
          <li className="flex items-center">
            <div className="block px-0 py-2 font-semibold transition-all ease-nav-brand text-sm text-slate-500 ml-6">
              {workState !== true ? (
                ...
                <button className={`${workBtnClass}`} onClick={offBtnHandler}>
                  퇴근
                </button>
              )}
            </div>
