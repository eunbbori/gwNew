    ...
    <div className="flex w-[30rem]">
      <div className="relative mb-3 w-[10rem] mr-5" data-te-input-wrapper-init>
        <input
          ...
          onChange={(e) => attendanceFilterVar({ name: e.target.value, dept: -1 })}
        />
        <label
          htmlFor="nameFilter"
      ...
      <div className="w-[10rem]">
        <select data-te-select-init data-te-select-filter="true" onChange={(e) => attendanceFilterVar({ name: '', dept: parseInt(e.target.value) })}>
